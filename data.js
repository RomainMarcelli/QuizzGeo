const QUIZ_DATA = {
  ...
  asia: {
    ...
    emoji: "🏯",
    countries: [
      { country: "Afghanistan", capital: "Kaboul", code: "af" },
      { country: "Arabie saoudite", capital: "Riyad", code: "sa" },
      { country: "Armenie", capital: "Erevan", code: "am" },
      { country: "Azerbaidjan", capital: "Bakou", code: "az", alternates: ["Baku"] },
      { country: "Bahrein", capital: "Manama", code: "bh" },
      { country: "Bangladesh", capital: "Dacca", code: "bd", alternates: ["Dhaka"] },
      { country: "Bhoutan", capital: "Thimphou", code: "bt", alternates: ["Thimphu"] },
      { country: "Birmanie", capital: "Naypyidaw", code: "mm", countryAlternates: ["Myanmar"] },
      { country: "Brunei", capital: "Bandar Seri Begawan", code: "bn" },
      { country: "Cambodge", capital: "Phnom Penh", code: "kh" },
      { country: "Chine", capital: "Pekin", code: "cn", alternates: ["Beijing"] },
      { country: "Chypre", capital: "Nicosie", code: "cy" },
      { country: "Coree du Nord", capital: "Pyongyang", code: "kp" },
      { country: "Coree du Sud", capital: "Seoul", code: "kr" },
      { country: "Emirats arabes unis", capital: "Abou Dabi", code: "ae" },
      { country: "Georgie", capital: "Tbilissi", code: "ge", alternates: ["Tbilisi"] },
      { country: "Hong Kong", capital: "City of Victoria", code: "hk", alternates: ["Victoria"] },
      { country: "Ile Christmas", capital: "Flying Fish Cove", code: "cx" },
      { country: "Iles Cocos", capital: "West Island", code: "cc" },
      { country: "Inde", capital: "New Delhi", code: "in" },
      { country: "Indonesie", capital: "Nusantara", code: "id" },
      { country: "Irak", capital: "Bagdad", code: "iq", alternates: ["Baghdad"] },
      { country: "Iran", capital: "Teheran", code: "ir", alternates: ["Tehran"] },
      { country: "Israel", capital: "Jerusalem", code: "il" },
      { country: "Japon", capital: "Tokyo", code: "jp" },
      { country: "Jordanie", capital: "Amman", code: "jo" },
      { country: "Kazakhstan", capital: "Astana", code: "kz" },
      { country: "Kirghizistan", capital: "Bishkek", code: "kg" },
      { country: "Koweit", capital: "Koweit", code: "kw" },
      { country: "Laos", capital: "Vientiane", code: "la" },
      { country: "Liban", capital: "Beyrouth", code: "lb", alternates: ["Beirut"] },
      { country: "Macao", capital: "Macao", code: "mo" },
      { country: "Malaisie", capital: "Kuala Lumpur", code: "my" },
      { country: "Maldives", capital: "Male", code: "mv", alternates: ["Male City"] },
      { country: "Mongolie", capital: "Oulan-Bator", code: "mn", alternates: ["Ulaanbaatar"] },
      { country: "Nepal", capital: "Kathmandou", code: "np", alternates: ["Kathmandu"] },
      { country: "Oman", capital: "Muscat", code: "om" },
      { country: "Ouzbekistan", capital: "Tachkent", code: "uz", alternates: ["Tashkent"] },
      { country: "Pakistan", capital: "Islamabad", code: "pk" },
      { country: "Palestine", capital: "Ramallah", code: "ps" },
      { country: "Philippines", capital: "Manille", code: "ph", alternates: ["Manila"] },
      { country: "Qatar", capital: "Doha", code: "qa" },
      { country: "Singapour", capital: "Singapour", code: "sg" },
      { country: "Sri Lanka", capital: "Sri Jayawardenepura Kotte", code: "lk" },
      { country: "Syrie", capital: "Damas", code: "sy" },
      { country: "Tadjikistan", capital: "Douchanbe", code: "tj", alternates: ["Dushanbe"] },
  ...
  antarctica: {
    ...
    emoji: "🧊",
    countries: [
      { country: "Antarctique", capital: "Inconnue", code: "aq", alternates: ["Inconnu"] },
      {
        country: "Georgie du Sud-et-les Iles Sandwich du Sud",
        capital: "King Edward Point",
        code: "gs",
      },
      { country: "Ile Bouvet", capital: "Inconnue", code: "bv", alternates: ["Inconnu"] },
      {
        country: "Iles Heard-et-Macdonald",
        capital: "Inconnue",
        code: "hm",
        alternates: ["Inconnu"],
      },
      {
        country: "Terres australes et antarctiques francaises",
  ...
  africa: {
    ...
    emoji: "🦁",
    countries: [
      { country: "Afrique du Sud", capital: "Pretoria", code: "za" },
      { country: "Algerie", capital: "Alger", code: "dz" },
      ...
      { country: "Cameroun", capital: "Yaounde", code: "cm" },
      { country: "Comores", capital: "Moroni", code: "km" },
      ...
      { country: "Egypte", capital: "Le Caire", code: "eg", alternates: ["Cairo"] },
      { country: "Erythree", capital: "Asmara", code: "er" },
      { country: "Eswatini", capital: "Mbabane", code: "sz" },
      { country: "Ethiopie", capital: "Addis Abeba", code: "et", alternates: ["Addis Ababa"] },
      { country: "Gabon", capital: "Libreville", code: "ga" },
      { country: "Gambie", capital: "Banjul", code: "gm" },
      { country: "Ghana", capital: "Accra", code: "gh" },
      { country: "Guinee", capital: "Conakry", code: "gn" },
      {
      ...
      { country: "Guinee-Bissau", capital: "Bissau", code: "gw" },
      { country: "Ile Maurice", capital: "Port Louis", code: "mu" },
      { country: "Iles du Cap-Vert", capital: "Praia", code: "cv" },
      { country: "Kenya", capital: "Nairobi", code: "ke" },
      { country: "Lesotho", capital: "Maseru", code: "ls" },
      { country: "Liberia", capital: "Monrovia", code: "lr" },
      { country: "Libye", capital: "Tripoli", code: "ly" },
      ...
      { country: "Maroc", capital: "Rabat", code: "ma" },
      { country: "Mauritanie", capital: "Nouakchott", code: "mr" },
      { country: "Mayotte", capital: "Mamoudzou", code: "yt" },
      { country: "Mozambique", capital: "Maputo", code: "mz" },
      { country: "Namibie", capital: "Windhoek", code: "na" },
      { country: "Niger", capital: "Niamey", code: "ne" },
      { country: "Nigeria", capital: "Abuja", code: "ng" },
      { country: "Ouganda", capital: "Kampala", code: "ug" },
      { country: "Republique centrafricaine", capital: "Bangui", code: "cf" },
      { country: "Republique democratique du Congo", capital: "Kinshasa", code: "cd" },
      { country: "Reunion", capital: "Saint-Denis", code: "re" },
      { country: "Rwanda", capital: "Kigali", code: "rw" },
      { country: "Sahara occidental", capital: "El Aaiun", code: "eh", alternates: ["Laayoune"] },
      {
        country: "Sainte-Helene, Ascension et Tristan da Cunha",
        capital: "Jamestown",
        code: "sh",
      },
      { country: "Sao Tome et Principe", capital: "Sao Tome", code: "st" },
      ...
      { country: "Somalie", capital: "Mogadiscio", code: "so", alternates: ["Mogadishu"] },
      { country: "Soudan", capital: "Khartoum", code: "sd" },
      { country: "Soudan du Sud", capital: "Juba", code: "ss" },
      { country: "Tanzanie", capital: "Dodoma", code: "tz" },
      { country: "Tchad", capital: "N'Djamena", code: "td", alternates: ["Ndjamena"] },
      { country: "Togo", capital: "Lome", code: "tg" },
      { country: "Tunisie", capital: "Tunis", code: "tn" },
      { country: "Zambie", capital: "Lusaka", code: "zm" },
